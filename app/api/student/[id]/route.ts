  ...
  try {
    ...
    return NextResponse.json({
      ...
      payments: payments.map((p) => ({
        ...
        hyperpgOrderId: p.hyperpgOrderId ?? null,
        hyperpgTxnId: p.hyperpgTxnId ?? null,
        hyperpgStatus: p.hyperpgStatus ?? null,
        hyperpgStatusId: p.hyperpgStatusId ?? null,
        hyperpgEffectiveAmount: p.hyperpgEffectiveAmount ?? null,
        hyperpgRefunded: p.hyperpgRefunded ?? false,
        hyperpgAmountRefunded: p.hyperpgAmountRefunded ?? 0,
      })),
      attendanceTrends,
      academicPerformance,
